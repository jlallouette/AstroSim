...
static DerivedFactory<StimulationStrat, ExtraCellKStim> ExtraCellKStimFact;
...
static DerivedFactory<SimulationManager, RepeatSimulation<KChIModel> > RepeatKChISimFact;
...
static DerivedFactory<SimulationManager, RepeatSimulation<FireDiffuseModel> > RepeatFireDiffuseModelFact;
...
static DerivedFactory<ChIModel, KChIModel > KChIModFact;
...
void InitializeFactories()
{
	...
	AbstractFactory<StimulationStrat>::Factories.insert(make_pair(ExtraCellKStim::ClassName, &ExtraCellKStimFact));
	...
	AbstractFactory<SimulationManager>::Factories.insert(make_pair(RepeatSimulation<KChIModel>::ClassName, &RepeatKChISimFact));
	...
	AbstractFactory<SimulationManager>::Factories.insert(make_pair(RepeatSimulation<FireDiffuseModel>::ClassName, &RepeatFireDiffuseModelFact));
	...
	AbstractFactory<ChIModel>::Factories.insert(make_pair(KChIModel::ClassName, &KChIModFact));
